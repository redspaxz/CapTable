...
<form method="post" action="<?= url('/options') ?>" id="grantForm">
  ...
  <div class="row g-3">
    ...
    <div class="col-md-4">
      <label class="form-label" for="share_class_id">Underlying class *</label>
    ...
    <div class="col-md-3">
      ...
      <div class="form-text">0 = no cliff</div>
    </div>
    <div class="col-12">
  ...
  <a href="<?= url('/options') ?>" class="btn btn-outline-secondary">Cancel</a>
</form>
</div></div>
